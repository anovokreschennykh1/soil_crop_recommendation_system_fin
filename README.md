...
- Он забирает от пользователя фотографию почвы на которой планируетя начать культивирование
...
- Дообученная модель для классификации изображений [microsoft/resnet-50](https://huggingface.co/microsoft/resnet-50) на которой прогнали трейн датасет с фотографиям почв размеченных по 7 классам
